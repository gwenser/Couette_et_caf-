        ...
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["room"] ?? null), "comments", [], "any", false, false, false, 55)) > 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["comment"]) {
                ...
                if ((($context["client"] ?? null) == twig_get_attribute($this->env, $this->source, $context["comment"], "client", [], "any", false, false, false, 59))) {
                    ...
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("comment_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["comment"], "id", [], "any", false, false, false, 60)]), "html", null, true);
...
", "room/show.html.twig", "/home/serandour/AgVoyFinal/finalProject/templates/room/show.html.twig");
    }
}
